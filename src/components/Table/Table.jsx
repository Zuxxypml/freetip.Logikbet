        ...
        <table className="w-full table-auto border border-collapse">
          <thead>
            <tr className="h-12">
              ...
              <th className="border text-center p-2">Outcome Predictions</th>
          ...
          <tbody className="p-5">
            {tableData?.map((row, index) => (
              <tr key={index} className="text-center py-4 h-16 my-2">
                ...
                <td className="p-2 border flex flex-col items-center gap-2 justify-center md:flex-row md:justify-center md:items-center md:gap-1">
